...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        const fetchCategories = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    const savedCategories = JSON.parse(localStorage.getItem('categories') || '["My Break", "Ghassanko"]');
        ...
        const defaultContent = {
            ...
            about: {
                ...
                myBreakSection: {
                    title: 'مجموعة ماي بريك',
                    subtitle: 'الراحة والاسترخاء',
                    description: 'مجموعة "ماي بريك" هي تجسيد لمفهوم الراحة الحقيقية. كنبنا وكراسي اللايزي بوي مصممة بأحدث التقنيات لتوفر لك تجربة استرخاء لا مثيل لها.',
                    features: ['جلد طبيعي فاخر 100%', 'تقنيات مساج متطورة', 'ضمان 5 سنوات'],
                    image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=600&h=400&fit=crop'
                },
                ghassankoSection: {
                    title: 'مجموعة غسانكو',
                    subtitle: 'الأناقة الكلاسيكية',
                    description: 'مجموعة "غسانكو" تجسد الأناقة الكلاسيكية والحرفية التقليدية. قطع أثاث مصنوعة من أجود أنواع الخشب الطبيعي بتصاميم خالدة تضفي لمسة من الفخامة على منزلك.',
                    features: ['خشب طبيعي عالي الجودة', 'حرفية يدوية متقنة', 'تصاميم كلاسيكية خالدة'],
                    image: 'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=600&h=400&fit=crop'
                },
                values: {
                    ...
                    items: {
                        quality: {
                            title: 'الجودة',
                            description: 'نحرص على استخدام أجود المواد والعمل مع أمهر الحرفيين لضمان أعلى معايير الجودة'
                        },
                        comfort: {
                            title: 'الراحة',
                            description: 'راحة عملائنا هي أولويتنا، نصمم كل قطعة لتوفر أقصى درجات الراحة والاسترخاء'
                        },
                        innovation: {
                            title: 'الابتكار',
                            description: 'نواكب أحدث التقنيات والتصاميم لنقدم منتجات مبتكرة تلبي احتياجات العصر'
                        }
                    }
                },
                cta: {
                    title: 'جاهز لتجربة الفرق؟',
                    description: 'زر معرضنا اليوم واكتشف مجموعتنا الكاملة من الأثاث الفاخر',
            ...
            contact: {
                ...
                description: 'تواصل معنا للحصول على استشارة مجانية أو لأي استفسارات حول منتجاتنا',
                phone: '+20 123 456 7890',
                email: 'info@mybreak-ghassanko.com',
                address: 'القاهرة، مصر',
                workingHours: 'السبت - الخميس: 9:00 ص - 9:00 م',
                mapUrl: 'https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d4189.440832738498!2d31.796640284851843!3d31.420960581402568!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMzHCsDI1JzE1LjUiTiAzMcKwNDcnNDAuMCJF!5e1!3m2!1sar!2seg!4v1761516415312!5m2!1sar!2seg',
                formTitle: 'أرسل لنا رسالة',
                formDescription: 'املأ النموذج أدناه وسنتواصل معك في أقرب وقت ممكن'
            },
            footer: {
                description: 'نحن نقدم أجود أنواع الأثاث المنزلي بتصاميم عصرية وكلاسيكية تناسب جميع الأذواق. من كنب ماي بريك الفاخرة إلى مجموعة غسانكو الكلاسيكية، نضمن لك الجودة والراحة.',
                phone: '+20 123 456 7890',
                email: 'info@mybreak-ghassanko.com',
                address: 'القاهرة، مصر',
        ...
        const savedProductPageSettings = JSON.parse(localStorage.getItem('productPageSettings') || '{}');
        ...
        setProductPageSettings({ ...defaultProductPageSettings, ...savedProductPageSettings });
        ...
        if (editingProduct) {
            ...
            try {
                ...
                const newProduct = {
                    ...
                    images: productData.images || ['https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800']
                };
    ...
    const handleDeleteCategory = (categoryToDelete) => {
        ...
        if (productsUsingCategory.length > 0) {
            toast.error(`لا يمكن حذف هذه الفئة لأنها تحتوي على ${productsUsingCategory.length} منتج`);
            return;
        }
    ...
    const handleSaveCategory = async (categoryName) => {
        ...
        if (editingCategory) {
            ...
            if (categories.includes(categoryName) && categoryName !== editingCategory) {
                toast.error('هذه الفئة موجودة بالفعل');
                return;
            }

            const updatedCategories = categories.map(c => c === editingCategory ? categoryName : c);
            setCategories(updatedCategories);
    ...
    const handleSaveContent = (sectionKey, contentData) => {
        ...
        if (sectionKey.startsWith('hero-slide-')) {
            const slideId = parseInt(sectionKey.replace('hero-slide-', ''));
            const updatedSlides = siteContent.hero?.slides?.map(slide =>
        ...
        else if (['bookingSection', 'featuresSection', 'gallery', 'breadcrumb'].includes(sectionKey)) {
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                            ...
                                            <div className="bg-green-50 rounded-lg p-4">
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="mr-4">
                                                        <p className="text-sm font-medium text-gray-600">الرسائل المقروءة</p>
                                                ...
                                                >
                                                    <div className="flex justify-between items-start mb-4">
                                                        <div className="flex items-center space-x-3 space-x-reverse">
                                                            <div className={`w-3 h-3 rounded-full ${message.isRead ? 'bg-gray-300' : 'bg-blue-500'}`}></div>
                                                            <div>
                                                    ...
                                                    <div className="flex justify-between items-center">
                                                        <div className="flex space-x-2 space-x-reverse">
                                                            ...
                                                            <a
                                                                href={`https://wa.me/${message.phone.replace(/[^0-9]/g, '')}?text=مرحباً ${message.name}، شكراً لتواصلك معنا`}
                                                                target="_blank"
                                                    ...
                                                    {message.isRead && message.readAt && (
                                                        <div className="mt-3 pt-3 border-t border-gray-200">
                                                            <p className="text-xs text-gray-500">
                                                                تم قراءة الرسالة في: {new Date(message.readAt).toLocaleDateString('ar-EG', {
                                                                    year: 'numeric',
                                                                    month: 'long',
                                                                    day: 'numeric',
                                                                    hour: '2-digit',
...
const ProductModal = ({ isOpen, product, categories, onSave, onClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        const images = imagePreview.length > 0 ? imagePreview : ['https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800'];
...
const CategoryModal = ({ isOpen, category, onSave, onClose }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={category ? 'تعديل الفئة' : 'إضافة فئة جديدة'}>
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                        اسم الفئة *
...
const AdvancedProductEditModal = ({ isOpen, product, categories, onSave, onClose }) => {
    const [formData, setFormData] = useState({
        name: '',
        category: '',
        price: '',
    ...
    const handleSubmit = (e) => {
        ...
        const finalImages = imagePreview.length > 0 ? imagePreview : ['https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800'];
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-6">
                            <div className="bg-gray-50 rounded-lg p-4">
                                <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                                    <span className="bg-blue-100 p-2 rounded-lg ml-2">
                            ...
                            <div className="bg-gray-50 rounded-lg p-4">
                                <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                                    <span className="bg-green-100 p-2 rounded-lg ml-2">
                        ...
                        <div className="space-y-6">
                            <div className="bg-gray-50 rounded-lg p-4">
                                <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                                    <span className="bg-purple-100 p-2 rounded-lg ml-2">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mb-3">
                                            اسحب وأفلت الصور لإعادة ترتيبها. الصورة الأولى ستكون الصورة الرئيسية.
                                        </p>
                                        <DraggableImageList
                                            images={imagePreview}
                                            onReorder={(newImages) => {
